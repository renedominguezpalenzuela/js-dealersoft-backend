...
module.exports = (plugin) => {
  ...
  plugin.controllers.user.updateMe = async (ctx) => {
    ...
    const newData = _.pick(ctx.request.body.data, ['email', 'username', 'first_name', 'last_name', 'company_name', 'street', 'house_number', 'city', 'postal_code', 'phone', 'website', 'steuer_nr', 'ust_Idnr', 'geschaftsfuhrer', 'iban', 'bic_swift_code', 'hrb_walsrode', 'bank_name']);
